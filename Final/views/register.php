...
<body>
    ...
    <p class="subtitle">Create your account with valid details.</p>
    <hr>
    ...
    <form method="POST" action="index.php?action=register_submit">
        <table>
            <tr>
                <td>Username</td>
                <td>
                    <input class="field" type="text" name="username" value="<?php echo htmlspecialchars($old['username'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
